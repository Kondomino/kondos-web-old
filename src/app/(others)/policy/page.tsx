...
const PagePolicy = ({}) => {
  return (
    <div>
      <header className="text-center max-w-2xl mx-auto - mb-8 sm:mb-8 lg:mb-8 ">
        <Heading2>Política de Privacidade</Heading2>
      </header>
...
<br></br>
<br></br>
É política da Kondomino respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Kondomino, e outros sites que possuímos e operamos.
<br></br>
<br></br>
...
O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Kondomino oferece no site e com caráter enunciativo, mas não limitativo:
<br></br>
...
<br></br>
C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Kondomino, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.Mais informaçõesEsperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.
<br></br>
<br></br>Esta política é efetiva a partir de 18 julho de 2024.
      </div>
    </div>
  );
};

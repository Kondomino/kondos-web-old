...
import __conveniences from "./jsons/__conveniences.json";
import { DEMO_CATEGORIES } from "./taxonomies";
import { ConvenienceType, PostDataType } from "./types";
...
// Conviniences
const DEMO_CONVENIENCES = __conveniences.map((post, index): ConvenienceType => {
  return {
    ...post,
